...
- **[Unreal Engine 4.27](https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-engine-4-27-documentation?application_version=4.27)**, **[AirSim](https://github.com/microsoft/AirSim)**, and **[Cesium for Unreal](https://cesium.com/learn/unreal/)** — used for virtual scene construction, UAV flight simulation, and geospatial environment integration in the AerialMetric-Synthetic subset. - **[Google Earth Studio](https://www.google.com/earth/studio/)** and **[Google Earth Pro](https://www.google.com/earth/about/versions/)** — used for camera trajectory design and virtual aerial data generation in the AerialMetric-Synthetic subset.
